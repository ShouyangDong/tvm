...
# under the License.
"""Tests for WGMMA m64n8k16 Auto Tensorization"""
...
class MmaModule:
    ...
    def main(
        ...
        # with T.block("root"):
        C_reindex_m64n8k16_matrixC = T.alloc_buffer((4096, 4096), "float16", scope="m64n8k16.matrixC")
        ...
        X_reindex_shared_dyn_m64n8k16_matrixA = T.alloc_buffer(
            (4096, 4096), "float16", scope="m64n8k16.matrixA"
        )
        Y_reindex_shared_dyn_m64n8k16_matrixB = T.alloc_buffer(
            (4096, 4096), "float16", scope="m64n8k16.matrixB"
        )
        for ax0_0_0_ax1_0_0_fused in T.thread_binding(4, thread="blockIdx.x"):
            for ax0_0_1_ax1_0_1_fused in T.thread_binding(256, thread="blockIdx.y"):
                for ax0_0_2_ax1_0_2_fused in T.thread_binding(4, thread="threadIdx.y"):
                    for ax2_0_0 in T.serial(
                        ...
                        for ax2_0_1 in T.serial(
                            ...
                            for ax0_0, ax1_0 in T.grid(2, 1):
                                with T.block("X_reindex_shared.dyn_m64n8k16.matrixA_o"):
                                    v0_o = T.axis.spatial(
                                        128,
                                    ...
                                    T.writes(
                                        X_reindex_shared_dyn_m64n8k16_matrixA[
                                            v0_o * 32 : v0_o * 32 + 32, v1_o * 8 : v1_o * 8 + 8
                                        ]
                                    )
                                    T.block_attr(
                                        {
                                            "meta_schedule.auto_tensorize": "mma_load_m64n8k16_f16_A_shared_dyn",
                                            "permuted_layout": "s2l_A",
                                        }
                                    )
                                    for ax0_1, ax1_1 in T.grid(32, 8):
                                        with T.block("X_reindex_shared.dyn_m64n8k16.matrixA"):
                            ...
                            for ax0_0, ax1_0 in T.grid(1, 2):
                                with T.block("Y_reindex_shared.dyn_m64n8k16.matrixB_o"):
                                    ...
                                    T.writes(
                                        Y_reindex_shared_dyn_m64n8k16_matrixB[
                                            v0_o * 8 : v0_o * 8 + 8, v1_o * 32 : v1_o * 32 + 32
                                        ]
                                    )
                                    T.block_attr(
                                        {
                                            "meta_schedule.auto_tensorize": "mma_load_m64n8k16_f16_B_shared_dyn",
                                            "permuted_layout": "s2l_B",
                                        }
                                    )
                                    for ax0_1, ax1_1 in T.grid(8, 32):
                                        with T.block("Y_reindex_shared.dyn_m64n8k16.matrixB"):
                                            v0_i, v1_i = T.axis.remap("SS", [ax0_1, ax1_1])
                                            T.reads(
                                                Y_reindex_shared_dyn[
                            ...
                            for ax0_0_3, ax1_0_3, ax2_0_2, ax0_0_4, ax1_0_4 in T.grid(
                                ...
                                with T.block("C_o"):
                                    ...
                                    T.writes(
                                        C_reindex_m64n8k16_matrixC[
                                            v0_o * 16 : v0_o * 16 + 16, v1_o * 8 : v1_o * 8 + 8
                                        ]
                                    )
                                    T.block_attr(
                                        {
                                            "meta_schedule.auto_tensorize": "mma_sync_m64n8k16_f16f16f16",
                                            "meta_schedule.auto_tensorize_init": "mma_init_m64n8k16_f16",
                    ...
                    with T.block("C_reindex_m64n8k16.matrixC"):
                        v0, v1, v2 = T.axis.remap(
                            "SSS",
...
def multi_level_tiling_mma(out_dtype):
    ...
    return ms.schedule_rule.MultiLevelTilingTensorCore(
        intrin_groups=[
            {
                "init": f"mma_init_m64n8k16_{out_dtype}",
                "load_a": "mma_load_m64n8k16_f16_A_shared_dyn",
                "load_b": "mma_load_m64n8k16_f16_B_shared_dyn",
                "compute": f"mma_sync_m64n8k16_f16f16{out_dtype}",
                "store": f"mma_store_m64n8k16_{out_dtype}_global",
            },
        ],
        structure="SSSRRSRS",
...
extern "C" __global__ void __launch_bounds__(128) main_kernel(half* __restrict__ C, half* __restrict__ X, half* __restrict__ Y) {
  ...
  uint1 C_reindex_m64n8k16_matrixC[64];
  half X_reindex_shared_dyn_m64n8k16_matrixA[32];
  half Y_reindex_shared_dyn_m64n8k16_matrixB[32];
  for (int ax0_0_4_init = 0; ax0_0_4_init < 4; ++ax0_0_4_init) {
    for (int ax1_0_4_init = 0; ax1_0_4_init < 8; ++ax1_0_4_init) {
      for (int b = 0; b < 2; ++b) {
        C_reindex_m64n8k16_matrixC[(((ax0_0_4_init * 16) + (ax1_0_4_init * 2)) + b)] = make_uint1(__pack_half2(__float2half_rn(0.000000e+00f), __float2half_rn(0.000000e+00f)));
      }
    }
  }
...
__asm__ __volatile__("cp.async.wait_group 1;");
...

  {
    ...
    __asm__ __volatile__(
      ...
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0 * 8)))[0]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0 * 8)))[1]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0 * 8)))[2]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0 * 8)))[3])
      : "r"(addr)
    );
  }
  }
...

  {
    ...
    __asm__ __volatile__(
      ...
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0 * 8)))[0]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0 * 8)))[1]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0 * 8)))[2]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0 * 8)))[3])
      : "r"(addr)
    );
  }
  }
...
__asm__ __volatile__("cp.async.wait_group 1;");
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1 + 1) & 1) * 16) + (ax0_0_1 * 8))))[0]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1 + 1) & 1) * 16) + (ax0_0_1 * 8))))[1]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1 + 1) & 1) * 16) + (ax0_0_1 * 8))))[2]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1 + 1) & 1) * 16) + (ax0_0_1 * 8))))[3])
      : "r"(addr)
    );
  }
      }
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1 + 1) & 1) * 16) + (ax1_0_1 * 8))))[0]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1 + 1) & 1) * 16) + (ax1_0_1 * 8))))[1]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1 + 1) & 1) * 16) + (ax1_0_1 * 8))))[2]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1 + 1) & 1) * 16) + (ax1_0_1 * 8))))[3])
      : "r"(addr)
    );
  }
      }
  ...
  {
    __asm__ __volatile__(
      "mma.sync.aligned.m64n8k16.row.col.f16.f16.f16.f16"
      "{%0, %1}, {%2, %3}, {%4}, {%5, %6};\n"
      :  "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4 * 16) + (ax1_0_4 * 2))))[0]), "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4 * 16) + (ax1_0_4 * 2))))[1])
      : "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (((ax2_0_1 & 1) * 16) + (ax0_0_4 * 4))))[0]), "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (((ax2_0_1 & 1) * 16) + (ax0_0_4 * 4))))[1]), "r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (((ax2_0_1 & 1) * 16) + (ax1_0_4 * 2))))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4 * 16) + (ax1_0_4 * 2))))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4 * 16) + (ax1_0_4 * 2))))[1]));
  }
        }
      }
    }
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0_2 * 8)))[0]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0_2 * 8)))[1]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0_2 * 8)))[2]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0_2 * 8)))[3])
      : "r"(addr)
    );
  }
    }
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0_2 * 8)))[0]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0_2 * 8)))[1]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0_2 * 8)))[2]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0_2 * 8)))[3])
      : "r"(addr)
    );
  }
    }
...

  {
    __asm__ __volatile__(
      "mma.sync.aligned.m64n8k16.row.col.f16.f16.f16.f16"
      "{%0, %1}, {%2, %3}, {%4}, {%5, %6};\n"
      :  "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_1 * 16) + (ax1_0_4_1 * 2))))[0]), "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_1 * 16) + (ax1_0_4_1 * 2))))[1])
      : "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((ax0_0_4_1 * 4) + 16)))[0]), "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((ax0_0_4_1 * 4) + 16)))[1]), "r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((ax1_0_4_1 * 2) + 16)))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_1 * 16) + (ax1_0_4_1 * 2))))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_1 * 16) + (ax1_0_4_1 * 2))))[1]));
  }
      }
    }
  }
__asm__ __volatile__("cp.async.wait_group 0;");
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1_1 + 1) & 1) * 16) + (ax0_0_3 * 8))))[0]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1_1 + 1) & 1) * 16) + (ax0_0_3 * 8))))[1]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1_1 + 1) & 1) * 16) + (ax0_0_3 * 8))))[2]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1_1 + 1) & 1) * 16) + (ax0_0_3 * 8))))[3])
      : "r"(addr)
    );
  }
    }
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1_1 + 1) & 1) * 16) + (ax1_0_3 * 8))))[0]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1_1 + 1) & 1) * 16) + (ax1_0_3 * 8))))[1]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1_1 + 1) & 1) * 16) + (ax1_0_3 * 8))))[2]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1_1 + 1) & 1) * 16) + (ax1_0_3 * 8))))[3])
      : "r"(addr)
    );
  }
    }
...

  {
    __asm__ __volatile__(
      "mma.sync.aligned.m64n8k16.row.col.f16.f16.f16.f16"
      "{%0, %1}, {%2, %3}, {%4}, {%5, %6};\n"
      :  "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_2 * 16) + (ax1_0_4_2 * 2))))[0]), "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_2 * 16) + (ax1_0_4_2 * 2))))[1])
      : "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (((ax2_0_1_1 & 1) * 16) + (ax0_0_4_2 * 4))))[0]), "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (((ax2_0_1_1 & 1) * 16) + (ax0_0_4_2 * 4))))[1]), "r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (((ax2_0_1_1 & 1) * 16) + (ax1_0_4_2 * 2))))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_2 * 16) + (ax1_0_4_2 * 2))))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_2 * 16) + (ax1_0_4_2 * 2))))[1]));
  }
      }
    }
  }
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0_5 * 8)))[0]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0_5 * 8)))[1]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0_5 * 8)))[2]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (ax0_0_5 * 8)))[3])
      : "r"(addr)
    );
  }
  }
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0_5 * 8)))[0]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0_5 * 8)))[1]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0_5 * 8)))[2]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (ax1_0_5 * 8)))[3])
      : "r"(addr)
    );
  }
  }
...

  {
    __asm__ __volatile__(
      "mma.sync.aligned.m64n8k16.row.col.f16.f16.f16.f16"
      "{%0, %1}, {%2, %3}, {%4}, {%5, %6};\n"
      :  "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_3 * 16) + (ax1_0_4_3 * 2))))[0]), "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_3 * 16) + (ax1_0_4_3 * 2))))[1])
      : "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((ax0_0_4_3 * 4) + 16)))[0]), "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((ax0_0_4_3 * 4) + 16)))[1]), "r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((ax1_0_4_3 * 2) + 16)))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_3 * 16) + (ax1_0_4_3 * 2))))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_3 * 16) + (ax1_0_4_3 * 2))))[1]));
  }
    }
  }
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1_2 + 1) & 1) * 16) + (ax0_0_6 * 8))))[0]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1_2 + 1) & 1) * 16) + (ax0_0_6 * 8))))[1]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1_2 + 1) & 1) * 16) + (ax0_0_6 * 8))))[2]), "=r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((((ax2_0_1_2 + 1) & 1) * 16) + (ax0_0_6 * 8))))[3])
      : "r"(addr)
    );
  }
    }
...

  {
    ...
    __asm__ __volatile__(
      "ldmatrix.sync.aligned.m8n8.x4.trans.shared.b16"
      "{%0, %1, %2, %3}, [%4];\n"
      : "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1_2 + 1) & 1) * 16) + (ax1_0_6 * 8))))[0]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1_2 + 1) & 1) * 16) + (ax1_0_6 * 8))))[1]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1_2 + 1) & 1) * 16) + (ax1_0_6 * 8))))[2]), "=r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((((ax2_0_1_2 + 1) & 1) * 16) + (ax1_0_6 * 8))))[3])
      : "r"(addr)
    );
  }
    }
...

  {
    __asm__ __volatile__(
      "mma.sync.aligned.m64n8k16.row.col.f16.f16.f16.f16"
      "{%0, %1}, {%2, %3}, {%4}, {%5, %6};\n"
      :  "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_4 * 16) + (ax1_0_4_4 * 2))))[0]), "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_4 * 16) + (ax1_0_4_4 * 2))))[1])
      : "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (((ax2_0_1_2 & 1) * 16) + (ax0_0_4_4 * 4))))[0]), "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + (((ax2_0_1_2 & 1) * 16) + (ax0_0_4_4 * 4))))[1]), "r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + (((ax2_0_1_2 & 1) * 16) + (ax1_0_4_4 * 2))))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_4 * 16) + (ax1_0_4_4 * 2))))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_4 * 16) + (ax1_0_4_4 * 2))))[1]));
  }
      }
    }
  }
...

  {
    __asm__ __volatile__(
      "mma.sync.aligned.m64n8k16.row.col.f16.f16.f16.f16"
      "{%0, %1}, {%2, %3}, {%4}, {%5, %6};\n"
      :  "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_5 * 16) + (ax1_0_4_5 * 2))))[0]), "=r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_5 * 16) + (ax1_0_4_5 * 2))))[1])
      : "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((ax0_0_4_5 * 4) + 16)))[0]), "r"(((unsigned *)(X_reindex_shared_dyn_m64n8k16_matrixA + ((ax0_0_4_5 * 4) + 16)))[1]), "r"(((unsigned *)(Y_reindex_shared_dyn_m64n8k16_matrixB + ((ax1_0_4_5 * 2) + 16)))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_5 * 16) + (ax1_0_4_5 * 2))))[0]), "r"(((unsigned *)(C_reindex_m64n8k16_matrixC + ((ax0_0_4_5 * 16) + (ax1_0_4_5 * 2))))[1]));
  }
    }
  }
  for (int ax0_0_7 = 0; ax0_0_7 < 8; ++ax0_0_7) {
    ...
    for (int ax1_0_7 = 0; ax1_0_7 < 8; ++ax1_0_7) {
      *(uint1*)(((half*)buf_dyn_shmem) + ((((((int)threadIdx.x) * 2050) + (((int)threadIdx.y) * 512)) + (ax1_0_7 * 64)) + 12288)) = C_reindex_m64n8k16_matrixC[((((ax0_0_7 >> 1) * 16) + (ax1_0_7 * 2)) + (ax0_0_7 & 1))];
    }
    __syncthreads();
...
def initializer():
    ...
    def async_build(mod, target, _params):  # pylint: disable=unused-variable, unused-argument
        ...
        # re-import here for local builder to register index_map_m64n8k16_matrixC
